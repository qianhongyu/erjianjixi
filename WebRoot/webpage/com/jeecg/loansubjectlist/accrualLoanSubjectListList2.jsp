...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="accrualLoanSubjectListList" checkbox="true" pagination="true" fitColumns="true" title="借款主体列表" actionUrl="accrualLoanSubjectListController.do?datagrid2" idField="id" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="accrualLoanSubjectListController.do?goAdd&id=2" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="accrualLoanSubjectListController.do?goUpdate&id=2" funname="update"></t:dgToolBar>
   ...
   <t:dgToolBar title="查看" icon="icon-search" url="accrualLoanSubjectListController.do?goUpdate&id=2" funname="detail"></t:dgToolBar>

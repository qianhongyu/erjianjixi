...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="financinginfolistList" checkbox="true" pagination="true" fitColumns="true" title="融资信息列表" actionUrl="financinginfolistController.do?datagrid5" idField="id" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="financinginfolistController.do?goAdd&id=5" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="financinginfolistController.do?goUpdate&id=5" funname="update"></t:dgToolBar>
   ...
   <t:dgToolBar title="查看" icon="icon-search" url="financinginfolistController.do?goUpdate&id=5" funname="detail"></t:dgToolBar>

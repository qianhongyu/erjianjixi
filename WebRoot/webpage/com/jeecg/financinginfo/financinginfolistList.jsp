...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="financinginfolistList" checkbox="true" pagination="true" fitColumns="true" title="融资信息列表" actionUrl="financinginfolistController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="financinginfolistController.do?goAdd&id=1" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="financinginfolistController.do?goUpdate&id=1" funname="update"></t:dgToolBar>
   ...
   <t:dgToolBar title="查看" icon="icon-search" url="financinginfolistController.do?goUpdate&id=1" funname="detail"></t:dgToolBar>
...
//导入
function ImportXls() {
	openuploadwin('Excel导入', 'financinginfolistController.do?upload', "financinginfolistList");
}

//导出
function ExportXls() {
	JeecgExcelExport("financinginfolistController.do?exportXls","financinginfolistList");
}

//模板下载
function ExportXlsByT() {
	JeecgExcelExport("financinginfolistController.do?exportXlsByT","financinginfolistList");
}

...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="accrualHetong2Controller.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
							  <t:dictSelect field="contractstatus" type="list"  dictTable="accrual_htzt" dictField="id" dictText="text"  defaultVal="${accrualHetong2Page.contractstatus}" hasLabel="false"  title="合同状态" ></t:dictSelect>     
				...
				<tr>
					...
					<td class="value">
							  <t:dictSelect field="contractnature" type="list"  dictTable="accrual_htxz" dictField="id" dictText="text"  defaultVal="${accrualHetong2Page.contractnature}" hasLabel="false"  title="合同性质" ></t:dictSelect>     
							<span class="Validform_checktip"></span>
  ...
  <script src = "webpage/com/jeecg/hetong2/accrualHetong2.js"></script>		

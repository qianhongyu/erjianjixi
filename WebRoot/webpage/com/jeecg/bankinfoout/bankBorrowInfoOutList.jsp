...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="bankBorrowInfoOutList" checkbox="false" pagination="true" fitColumns="true" title="银行对外" actionUrl="bankBorrowInfoOutController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgDelOpt title="删除" url="bankBorrowInfoOutController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o"/>
   <t:dgToolBar title="录入" icon="icon-add" url="bankBorrowInfoOutController.do?goAdd" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="bankBorrowInfoOutController.do?goUpdate" funname="update"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="bankBorrowInfoOutController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="bankBorrowInfoOutController.do?goUpdate" funname="detail"></t:dgToolBar>
 ...
 <script src = "webpage/com/jeecg/bankinfoout/bankBorrowInfoOutList.js"></script>		
...
//导入
function ImportXls() {
	openuploadwin('Excel导入', 'bankBorrowInfoOutController.do?upload', "bankBorrowInfoOutList");
}

//导出
function ExportXls() {
	JeecgExcelExport("bankBorrowInfoOutController.do?exportXls","bankBorrowInfoOutList");
}

//模板下载
function ExportXlsByT() {
	JeecgExcelExport("bankBorrowInfoOutController.do?exportXlsByT","bankBorrowInfoOutList");
}

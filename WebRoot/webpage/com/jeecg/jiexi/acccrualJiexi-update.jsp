...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="acccrualJiexiController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="interestcycle" name="interestcycle" type="text" style="width: 150px" class="inputxt"  datatype="n"  ignore="checked"  value='${acccrualJiexiPage.interestcycle}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="lastday" name="lastday" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${acccrualJiexiPage.lastday}'/>
							<span class="Validform_checktip"></span>

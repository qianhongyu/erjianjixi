...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="accrualHetong1List" checkbox="true" pagination="true" fitColumns="true" title="银行对内" actionUrl="accrualHetong1Controller.do?datagrid" idField="id" fit="true" queryMode="group">
 ...
 <script src = "webpage/com/jeecg/yinhang/accrualHetong1List.js"></script>		

...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="accrualHetong3List" checkbox="true" pagination="true" fitColumns="true" title="集团借款" actionUrl="accrualHetong3Controller.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="区域公司"  field="companyarea"  queryMode="single"  width="120"></t:dgCol>
 ...
 <script src = "webpage/com/jeecg/jiekuan/accrualHetong3List.js"></script>		

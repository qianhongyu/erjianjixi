package com.jeecg.info1.service.impl;
...
@Service("accrualInfo1Service")
@Transactional
public class AccrualInfo1ServiceImpl extends CommonServiceImpl implements AccrualInfo1ServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(AccrualInfo1Entity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(AccrualInfo1Entity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(AccrualInfo1Entity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(AccrualInfo1Entity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,AccrualInfo1Entity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("accrual_info1",data);
				}
			} catch (Exception e) {
				e.printStackTrace();

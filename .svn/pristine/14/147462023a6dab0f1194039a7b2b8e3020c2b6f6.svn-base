 ...
 */
@Entity
@Table(name = "accrual_diya", schema = "")
@SuppressWarnings("serial")
public class AccrualDiyaEntity implements java.io.Serializable {
	/**主键*/
	...
	/**质押物*/
	@Excel(name="质押物",width=15)
	private java.lang.String pledge;
	/**评估价值*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  质押物
	 */

	@Column(name ="PLEDGE",nullable=true,length=50)

package com.jeecg.yinhang.service.impl;
...
@Service("accrualHetong1Service")
@Transactional
public class AccrualHetong1ServiceImpl extends CommonServiceImpl implements AccrualHetong1ServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(AccrualHetong1Entity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(AccrualHetong1Entity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(AccrualHetong1Entity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(AccrualHetong1Entity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,AccrualHetong1Entity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("accrual_hetong1",data);
				}
			} catch (Exception e) {
				e.printStackTrace();

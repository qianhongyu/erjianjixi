package com.jeecg.yinhang.entity;
 ...
 * @date 2018-01-19 09:07:24
 * @version V1.0   
 *
 */
@Entity
@Table(name = "accrual_hetong1", schema = "")
@SuppressWarnings("serial")
public class AccrualHetong1Entity implements java.io.Serializable {
	/**主键*/

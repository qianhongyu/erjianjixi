package com.jeecg.yinhang1.service.impl;
import com.jeecg.yinhang1.service.AccrualHetong2ServiceI;
...
@Service("accrualHetong2Service")
@Transactional
public class AccrualHetong2ServiceImpl extends CommonServiceImpl implements AccrualHetong2ServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(AccrualHetong2Entity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(AccrualHetong2Entity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(AccrualHetong2Entity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(AccrualHetong2Entity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,AccrualHetong2Entity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("accrual_hetong2",data);
				}
			} catch (Exception e) {
				e.printStackTrace();

package com.jeecg.yinhang1.entity;
 ...
 */
@Entity
@Table(name = "accrual_hetong2", schema = "")
@SuppressWarnings("serial")
public class AccrualHetong2Entity implements java.io.Serializable {
	/**主键*/
	private java.lang.String id;
	/**合同状态*/
	@Excel(name="合同状态",width=15,dictTable ="accrual_zt",dicCode ="id",dicText ="text")
	...
	/**合同性质*/
	@Excel(name="合同性质",width=15,dictTable ="accrual_xz",dicCode ="id",dicText ="text")
	...
	@Column(name ="CONTRACTSTATUS",nullable=true,length=50)
	...
	@Column(name ="PROJECTDEPT",nullable=true,length=50)

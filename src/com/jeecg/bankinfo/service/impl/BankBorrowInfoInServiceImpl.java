package com.jeecg.bankinfo.service.impl;
...
@Service("bankBorrowInfoInService")
@Transactional
public class BankBorrowInfoInServiceImpl extends CommonServiceImpl implements BankBorrowInfoInServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(BankBorrowInfoInEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(BankBorrowInfoInEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(BankBorrowInfoInEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(BankBorrowInfoInEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,BankBorrowInfoInEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("bank_borrow_info_in",data);
				}
			} catch (Exception e) {
				e.printStackTrace();

package com.jeecg.jituaninfo.service.impl;
...
@Service("jituanBorrowInfoService")
@Transactional
public class JituanBorrowInfoServiceImpl extends CommonServiceImpl implements JituanBorrowInfoServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(JituanBorrowInfoEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(JituanBorrowInfoEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(JituanBorrowInfoEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(JituanBorrowInfoEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,JituanBorrowInfoEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("jituan_borrow_info",data);
				}
			} catch (Exception e) {
				e.printStackTrace();

package com.jeecg.info3.service.impl;
...
@Service("accrualInfo3Service")
@Transactional
public class AccrualInfo3ServiceImpl extends CommonServiceImpl implements AccrualInfo3ServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(AccrualInfo3Entity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(AccrualInfo3Entity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(AccrualInfo3Entity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(AccrualInfo3Entity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,AccrualInfo3Entity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("accrual_info3",data);
				}
			} catch (Exception e) {
				e.printStackTrace();

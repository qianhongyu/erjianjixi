package com.jeecg.interestcalculation.service.impl;
...
@Service("interestCalculationtlistService")
@Transactional
public class InterestCalculationtlistServiceImpl extends CommonServiceImpl implements InterestCalculationtlistServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(InterestCalculationtlistEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(InterestCalculationtlistEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(InterestCalculationtlistEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(InterestCalculationtlistEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,InterestCalculationtlistEntity t){
